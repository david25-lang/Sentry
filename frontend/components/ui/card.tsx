...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "glass-card text-card-foreground gap-4 overflow-hidden rounded-2xl py-4 text-xs/relaxed ring-1 ring-white/10 has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=sm]:gap-2 data-[size=sm]:py-3 data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-2xl *:[img:last-child]:rounded-2xl group/card flex flex-col",
        className
      )}
      {...props}
    />
